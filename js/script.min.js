...
function checkSystem() {
  ...
  if (window.electron && false && "YXJw" != btoa(electron.vars.arg)) {
...
function preparerArray() {
  ...
  tabToLoad = [{
    ...
    "params": {
      "keyname": "spritePolo",
      "path": "./" + app.folder + (1 == animSize ? appBrowserSchool ? "img/polo-sprite-tshirt.png" : "img/polo-sprite.png" : nameToHD(appBrowserSchool ? "img/polo-sprite-tshirt.png" : "img/polo-sprite.png")) // recode this to mimic old format
    }
  }, {
    "func": loadImage,
    "params": {
...
function checkRatingModul(g) {
  ...
  if (!((window.cordova || window.electron) && hasNetwork && !(null != storage.getItem("param-safe")) && true && ((null == storage.getItem("ratemsg") || "undefined" === storage.getItem("ratemsg")) && storage.setItem("ratemsg", "true:0"), null == (j = storage.getItem("ratemsg")) || "undefined" === (j = storage.getItem("ratemsg")) || (j = String(j).split(":"), k = Boolean("true" == j[0x0]), l = Number(j[0x1]), k && (0x5 <= ++l ? (rateShown = true, boxDialog.open(STR("pop.rateText"), STR("pop.rateTitle"), [STR("bt.nope"), STR("bt.later"), STR("bt.sure")], [function () {
    p(0x1);
  }, function () {
    p(0x2);
  }, function () {
